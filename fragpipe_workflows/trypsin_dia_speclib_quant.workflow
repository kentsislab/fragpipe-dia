# Workflow: F1_trypsin_lysc_DIA


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/data1/shahs3/users/preskaa/AMLproteogenomics/data/APS028_AML_PG2_analysis/fragpipe_out/2024-12-20-decoys-contam-proteome.fasta.fas
...
tmtintegrator.channel_num=TMT-0
