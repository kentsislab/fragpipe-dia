# Workflow: fragpipe23_trypsin_dia_speclib_quant


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/data1/shahs3/users/preskaa/AMLproteogenomics/data/APS028_AML_PG2_analysis/fragpipe_out/F1/PG2_restrictive/decoys-contam-proteome.fasta.fas
