...
def write_gtf(df: polars.DataFrame, export_path: Union[str, Path], headers:  t.List[str] = None):
    headers = headers or []
...
# gffcmp_results = snakemake.input["annotated_gtf"]
# output_file = snakemake.output["reannotated_gtf"]

gffcmp = read_gtf(gffcmp_results, result_type="pandas")
